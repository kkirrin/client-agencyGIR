...
export default function ChooseTimeBtn({ register, idx, shiftType, day, night }) {
    ...
    // Определяем активное состояние на основе day/night, если shiftType не задан
    const isDayActive = shiftType ? shiftType === 'day' : day;
    const isNightActive = shiftType ? shiftType === 'night' : night;
