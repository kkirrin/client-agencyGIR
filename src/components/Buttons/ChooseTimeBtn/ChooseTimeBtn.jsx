...
export default function ChooseTimeBtn({ register, idx, item }) {
    const { control } = useForm({
        defaultValues: {
            shiftType: item.Day ? 'day' : item.Night ? 'night' : '',
        },
    });
        ...
        <Controller
            ...
            render={({ field: { onChange, value } }) => (
                <>
                    ...
                    <label
                        htmlFor="day"
                        className={`${styles.smena_btn} ${styles.day} ${value === 'day' ? styles.active_white : ''}`}
                    >
                    ...
                    <label
                        htmlFor="night"
                        className={`${styles.smena_btn} ${styles.night} ${value === 'night' ? styles.active_black : ''}`}
                    >
                        <p>Ночь</p>
